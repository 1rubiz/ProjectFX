...
const askAi =async (e)=>{
    ...
    console.log(data);
    const request = new Request('http://localhost:3001/askai', {
      method: 'POST',
      // body: data,
      headers: {
	...
	return(
		<div className='flex flex-col gap-2 border-2 border-white p-1 mb-1'>
			...
			<button className='text-[2vh] text-white bg-[#0D1321] hover:bg-white hover:text-[#0D1321] mb-2 border-2 border-white h-[5vh] font-semibold'>Ask the AI Teacher</button>
		</div>
	)
}